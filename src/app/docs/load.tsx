          ...
          <DocLayout>
            <div className="max-w-4xl">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <h1 className="text-4xl font-bold text-white mb-2">Loading UI</h1>
      ...
      <div className="flex space-x-2">
        ...
        <div className="w-3 h-3 bg-cyan-500 rounded-full animate-bounce [animation-delay:0.3s]" />
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} className="flex items-center justify-between pt-8 mt-8 border-t border-slate-800">
                <Link to="/docs/not-found" className="group flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
                ...
                <Link to="/docs/api-routes" className="group flex items-center gap-2 text-right text-slate-400 hover:text-white transition-colors">
                  <div>
