...
const EDIT_URL = 'https://github.com/Binidu01/bini-official/edit/main/src/pages/docs/page.tsx'
                ...
                >
                  <div className="p-6 rounded-xl border border-white/10 bg-white/5">
                    ...
                    <div className="flex flex-wrap items-center gap-6">
                      <a href="https://github.com/Binidu01/bini-official/discussions" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white hover:text-cyan-400 transition-colors">
                        <MessageCircle className="w-4 h-4" />
                        GitHub Discussions
                        <ExternalLink className="w-3 h-3 opacity-50" />
                      </a>
                      <a href="https://github.com/Binidu01/bini-official" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white hover:text-cyan-400 transition-colors">
